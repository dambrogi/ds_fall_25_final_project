...
First we select a limited amount of variables as potential predictors, and eliminate other variables that may be duplicative or irrelevant. 
...
Then we create a dataframe for use with this model, dropping grometries which are not needed for this analysis. We drop census tracks with NA values. We then split the data into testing and training sets.
